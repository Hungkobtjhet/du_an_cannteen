            ...
            <div class="row">
                <div class="col-xl-6 col-md-6 col-sm-12">
                	<div class="widget">
                        ...
                        <p>Tại {{ config('site.name') }}, Chúng tôi tự hào mang đến cho bạn hương vị đích thực của Việt NamNam. Các món ăn được chế biến khéo léo và lòng hiếu khách nồng hậu của chúng tôi tạo nên trải nghiệm ẩm thực mà bạn sẽ không bao giờ quên.</p>
                    </div>
                    <div class="widget">
                    ...
                    <div class="widget">
                        ...
                        <ul class="contact_info contact_info_light">
                            ...
                            @if($firstRestaurantPhoneNumber)
                                <li><i class="ti-mobile"></i> <p>{{ $firstRestaurantPhoneNumber->phone_number }}</p></li>
                            @endif
                        </ul>
                    </div>
                </div>
                <div style="text-align: right; margin-top: 10px;">                         
                    <a href="https://www.google.com/maps/place/Tr%C6%B0%E1%BB%9Dng+Cao+%C4%90%E1%BA%B3ng+Kinh+t%E1%BA%BF+-+C%C3%B4ng+ngh%E1%BB%87+B%E1%BA%AFc+Khoa+(CTECH)/@20.8903871,105.8592607,17z"
                     target="_blank" style="display: inline-block;">                             
                        <iframe 
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d465.9431091349764!2d105.85926067630054!3d20.890387141513415!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x
                            3135b306c30f20b3%3A0xf0806e188cd4daea!2zVHLGsOG7nW5nIENhbyDEkeG6s25nIEvhu7kgdGh14bqtdCAtIEPDtG5nIG5naOG7hyBCw6FjaCBLaG9hIChDVEVDSCk!5e0!3m2!1svi!2s!4v1748585590110!5m2!1svi!2s"
                            width="100%"                                  
                            height="200"                                  
                            style="border:0;"                                  
                            allowfullscreen=""                                  
        ...
        <div class="row">
            <div class="col-12">
                <div class="bottom_footer border-top-tran">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-0 text-center"><script>document.write(new Date().getFullYear());</script> &copy;   Mọi quyền được bảo lưu | <span class="text_default">{{ config('site.name') }}</span></p>
                        </div>
                        <div class="col-md-6">
